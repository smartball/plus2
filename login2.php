        ...
        <div class="navbar yamm navbar-default" role="navigation" >
            <div class="container pt-0 pb-0">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top"><img src="logo/logop1.gif" width="80"></a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="blog.php">Want to Buy</a></li>
                        ...
                        <li class="page-scroll" href="index.php">
