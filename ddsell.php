...
<html>
    ...
    <body>
     ...
     //พบตัวแปร session ชื่อ message_success  แสดงว่าลงทะเบียนเสร็จสมบูรณ์แล้ว                    
       ...
       ?><br />
                            <span>คลิก <a href="login2.php">ที่นี้</a> เพื่อเข้าสู่ระบบ</span>
                        </div>
                        <?php
       ...
       ?>
                    ...
                    <form  method="post" enctype="multipart/form-data" id="registrationForm" name="registrationForm" action="">
                        ...
                        <div class="form-group">
                            ...
                            <select style="height: 43px" id="mem_pass" name="mem_pass">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mem_email"  name="mem_email" placeholder="อีเมล" style="width: 300px">
                        </div>
                        <div class="form-group">
                        ...
                        mem_user: {//ตรวจสอบการกรอกข้อมูลของ textfield ชื่อ mem_user (name="mem_user")
                            validators: {
                                notEmpty: {//ตรวจสอบค่าว่างของ mem_user
                                    message: 'กรุณากรอก ชื่อสินค้า ด้วย'
                                },
                                stringLength: {//ตรวจสอบขนาดตัวอักษรของ mem_user
                                    min: 4,
                                    max: 50,
                                    message: 'ชื่อสินค้า ต้องมีขนาดตัวอักษร  4-20 ตัวอักษรเท่านั้น'
                                },
